...
namespace almond {
    ...
    public:
        Engine(almond::RobustTime& m_timeSystem);
        Engine(size_t numThreads, bool running, almond::Scene* scene, size_t maxBufferSize, almond::RobustTime& m_timeSystem);
    ...
    extern "C" Engine* CreateEngine(size_t numThreads, bool running, Scene* scene, size_t maxBufferSize, almond::RobustTime& m_timeSystem);
    extern "C" void Run(Engine& core);
    extern "C" bool IsRunning(Engine& core);
    extern "C" void PrintFPS(Engine& core);
} // namespace almond
